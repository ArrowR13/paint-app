...
canvas.addEventListener('mousedown', function (e) {
    ...
    ctx.moveTo(mouse.x, mouse.y);
    if (scribble_on === true) {
        canvas.addEventListener('mousemove', scribbleMode);
    } else {
        canvas.addEventListener('mousemove', normalMode);
    }
});

document.addEventListener('mouseup', function (e) {
    if (scribble_on === true) {
        canvas.removeEventListener('mousemove', scribbleMode);
    } else {
        canvas.removeEventListener('mousemove', normalMode);
    }
});
